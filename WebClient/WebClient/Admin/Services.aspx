<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Services.aspx.cs" Inherits="WebClient.Admin.Services" %>
<!DOCTYPE html>
<html>
<head runat="server">
    ...
    <style>
        ...
        input[type=text] { padding: 8px; border: 1px solid #ccc; border-radius: 6px; font-size: 14px; margin-right: 8px; width: 180px; }
        select { padding: 8px; border: 1px solid #ccc; border-radius: 6px; font-size: 14px; margin-right: 8px; width: 180px; }
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="form-row">
                <asp:TextBox ID="TxtServiceName" runat="server" placeholder="Service Name"/>
                <asp:DropDownList ID="DdlBranch" runat="server"/>
                <asp:TextBox ID="TxtAvgDuration" runat="server" placeholder="Avg Duration (mins)" style="width:140px;"/>
            ...
            <asp:GridView ID="GvServices" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Actions">
                        <ItemTemplate>
                            <asp:Button runat="server" Text="Edit"   CommandName="EditRow"   CommandArgument='<%# Eval("ServiceId") %>' CssClass="btn btn-blue"/>
                            <asp:Button runat="server" Text="Delete" CommandName="DeleteRow" CommandArgument='<%# Eval("ServiceId") %>' CssClass="btn btn-red"
